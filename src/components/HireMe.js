  ...
  return (
    ...
    ">
      <div className="w-48 h-auto flex items-center justify-center relative md:w-24">
        ...
        <Link
          href="https://myaccount.google.com/personal-info?gar=WzEyMF0&hl=vi&utm_source=OGB&utm_medium=act"
          className="flex items-center justify-center absolute left-[50%] top-[50%] -translate-x-1/2 -translate-y-1/2 bg-dark text-light shadow-md border border-solid border-dark w-20 h-20 rounded-full font-semibold hover:bg-light hover:text-dark dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light
