...
import profilePic from "../../public/images/profile/kimnga_profile3.png";
...
export default function Home() {
  return (
    <>
      <Head>
        <title>Portfolio cua Kim Nga</title>
...
sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw"
            ...
            <div className="w-1/2 flex flex-col items-center justify-center self-center lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                As a student majoring in Russian Language, I am passionate about learning and exploring Russian culture. Discover my latest projects and articles, showcasing my knowledge and skills in this field.
              </p>
        ...
        <div className="absolute right-8 bottom-8 inline-block w-24 md:hidden">  
          <Image src={lightBulb} alt="Kim Nga" className="w-full h-auto" />
